...
const SERVICES = [
  ...
  { id: 16, name: "Quality Assurance — Notes, Diagnoses & Treatment Plans", desc: "Peer review of clinical documentation for completeness, coding accuracy, and regulatory compliance. Includes auditing progress notes, diagnosis codes, and treatment plan structure. No-BBS supervisory.", format: "No phone", availability: "Evenings, Weekends", suggested: 65, category: "qa" },
  ...
  { id: 7, name: "Content Writing", desc: "Newsletters, blog posts, and social media content for your practice — in your voice.", format: "No phone", availability: "Early AM, Evenings, Weekends", suggested: 100, category: "creative" },
...
const PACKAGES = [
  ...
  { id: "creative", name: "Creative Services", hours: null, desc: "Dedicated creative support — web copy, onboarding kits, and workflow docs.", includes: ["Website copy", "Onboarding kits", "SOP docs"], suggested: 65, color: "#fde8f5", range: null },
